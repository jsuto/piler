...
function browser_detect() {
   ...
   if(strstr($_SERVER['HTTP_USER_AGENT'], "Microsoft Outlook") || strstr($_SERVER['HTTP_USER_AGENT'], "Mozilla/4.0 (compatible; MSIE 7.0; Windows ")) { define('OUTLOOK', 1); } else { define('OUTLOOK', 0); }
