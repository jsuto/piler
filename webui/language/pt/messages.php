...
$_['text_empty_search_result'] = "Pesquisa sem resultado. Tente usar o caractere curinga (*) após uma palavra parcial (min. " . MIN_PREFIX_LEN . " characters), por exemplo duplic* para encontrar as palavras \"duplicar\", \"duplicado\", \"duplicação\", etc.";
...
$_['text_install_sudo_apply'] = "Adicione esta linha em /etc/sudoers.d/piler: 'www-data ALL=NOPASSWD: /usr/bin/systemctl reload piler'";
