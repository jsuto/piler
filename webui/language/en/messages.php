...
$_['text_install_sudo_apply'] = "Add the following to /etc/sudoers: 'www-data ALL=NOPASSWD: systemctl reload piler'";
...
$_['text_preview_pane'] = "Preview Pane";
$_['text_preview_pane_hint'] = "Click on a message to show";
