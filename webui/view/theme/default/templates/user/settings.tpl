...
<div class="container text-start">
  <div class="row justify-content-start">
    <div class="col-3"><?php print $text_email_addresses; ?></div>
    <div class="col-3"><?php print $emails; ?></div>
  </div>

<?php if(Registry::get('auditor_user') == 1 && RESTRICTED_AUDITOR == 1) { ?>
  <div class="row justify-content-start">
    <div class="col-3"><?php print $text_domains; ?></div>
    <div class="col-3"><?php print $domains; ?></div>
  </div>
<?php } ?>

<?php if($wildcard_domains && (Registry::get('auditor_user') == 0 || RESTRICTED_AUDITOR == 0)) { ?>
  <div class="row justify-content-start">
    <div class="col-3"><?php print $text_wildcard_domains; ?></div>
    <div class="col-3"><?php print $wildcard_domains; ?></div>
  </div>
<?php } ?>

  <div class="row justify-content-start">
    <div class="col-3"><?php print $text_groups; ?></div>
    <div class="col-3"><?php print $groups; ?></div>
  </div>

<?php if(ENABLE_FOLDER_RESTRICTIONS == 1) { ?>
  <div class="row justify-content-start">
    <div class="col-3"><?php print $text_folders; ?></div>
    <div class="col-3"><?php print $folders; ?></div>
  </div>
<?php } ?>
...
<div class="container text-start">
  ...
  <div class="row justify-content-start">
    <div class="col-3"><?php print $text_theme; ?></div>
    <div class="col-3">
  ...
  <div class="row justify-content-start">
    <div class="col-3"><?php print $text_language; ?></div>
    <div class="col-3">
...
<div class="container text-start">
  <div class="row justify-content-start">
    <div class="col-3"><?php print $text_enable; ?></div>
    <div class="col-3">
