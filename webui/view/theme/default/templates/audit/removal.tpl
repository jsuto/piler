...
<?php $i=0; foreach ($data as $d) { $i++; ?>
         <tr class="resultrow<?php if($i % 2) { ?> odd<?php } ?>">
            ...
            <td class="auditcell aaa"><a href="#" onclick="show_modal('removeApproveModal'); Piler.remove_message_id=<?php print $d['id']; ?>;"><?php print $text_remove; ?>&nbsp;<i class="bi bi-trash text-danger"></i></a></td>
            <td class="auditcell aaa"><a href="#" onclick="show_modal('removeRejectModal'); Piler.remove_message_id=<?php print $d['id']; ?>;"><?php print $text_cancel; ?>&nbsp;<i class="bi bi-ban"></i></a></td>
